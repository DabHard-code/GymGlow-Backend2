        ...
        <Card className="mb-6">
          <CardContent className="flex items-start gap-3 py-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground">
                During GymGlow Comp Week, eligible submissions can also count toward Crimson badges. AI scoring is practice feedback, not official judging or medical advice.
              </p>
            </div>
          </CardContent>
        </Card>
